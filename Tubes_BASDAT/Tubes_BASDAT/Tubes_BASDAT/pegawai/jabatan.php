    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div>
                    <a type="button" class="btn btn-primary" href="tambah_jabatan.php">Tambah Jabatan</a>
                </div>
                <br>
                <div>
                        ...
                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                            ...
                            ?>
                                    <tr class="odd">
                                        ...
                                        <td class=" "><?php echo ucfirst($row['id_jabatan']); ?></td>
                                        <td class=" "><?php echo ucfirst($row['nama_jabatan']); ?></td>
                                        <td class=" "><?php echo ucfirst($row['gaji_pokok']); ?></td>
                                        <td class=" "><?php echo ucfirst($row['tunjangan_jabatan']); ?></td>


                                        <td class=" ">
                                            <a type="button" class="btn btn-warning btn-xs" href="update_jabatan.php?id=<?php echo $row['id_jabatan']; ?>">Update</a>
                                            <a type="button" class="btn btn-danger btn-xs" href="delete_jabatan.php?id=<?php echo $row['id_jabatan']; ?>" onClick="return confirm('Menghapus data jabatan <?php echo ucfirst($row['id_jabatan']); ?> ?');">Delete</a>
                                        </td>
                                    </tr>
                            <?php
                                }
