        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="active"><a href=#>Log Pegawai</a></li>
                </ul>
            </div>
                ...
                <div>
                    <table id="example1" class="table table-bordered table-striped dataTable" aria-describedby="example1_info">
                        ...
                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                            <?php
                            $result = $mysqli->query("SELECT * FROM logPegawai");
                            ...
                            ?>
                                    <tr class="odd">
                                        ...
                                        <td class=" "><?php echo ucfirst($row['waktu']); ?></td>
                                        <td class=" "><?php echo ucfirst($row['Keterangan']); ?></td>
                                        <td class=" "><?php echo ucfirst($row['nip_lama']); ?></td>
                                        <td class=" "><?php echo ucfirst($row['nip_baru']); ?></td>
                                    </tr>
                            <?php
                                }
                            }
