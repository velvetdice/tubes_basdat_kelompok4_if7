            ...
            <tbody role="alert" aria-live="polite" aria-relevant="all">
              ...
              ?>
                  <tr class="odd">
                    ...
                    <td class=" "><?php echo $row['jk']; ?></td>
                    <td class=" "><?php echo $row['alamat']; ?></td>
                    <td class=" "><?php echo $row['id_jabatan']; ?></td>
                    <td class=" "><?php echo $row['id_tunjangan']; ?></td>
                    <td class=" ">
                      <a type="button" class="btn btn-warning btn-xs" href="update_pegawai.php?id=<?php echo $row['id_pegawai']; ?>">Update</a>
                      <a type="button" class="btn btn-danger btn-xs" href="delete_pegawai.php?id=<?php echo $row['id_pegawai']; ?>" onClick="return confirm('Menghapus data pegawai <?php echo $row['nama_pegawai']; ?> ?');">Delete</a>
                    </td>
                  </tr>
              <?php
                }
