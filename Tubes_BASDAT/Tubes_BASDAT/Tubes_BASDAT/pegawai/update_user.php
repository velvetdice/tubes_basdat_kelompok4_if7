              ...
              ?>
                  <form class="form-horizontal" action="proses_update_user.php?id=<?php echo $_GET['id']; ?>" method="POST">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="username" id="inputEmail3" placeholder="Masukkan Username untuk User baru" value="<?php echo $row['username']; ?>" required />
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label">Password</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="password" id="inputPassword3" placeholder="Masukkan Password untuk User baru" value="<?php echo $row['password']; ?>" required />
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <select name="level" id="disabledSelect" class="form-control">
                          <option value="user" <?php if ($row['level'] == 'username') echo "selected"; ?>>User</option>
