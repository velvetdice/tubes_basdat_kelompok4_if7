    ...
    <div class="row">
      <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
          ...
          <li><a href="log_Update.php">Log Pegawai</a></li>
        </ul>
      </div>
              ...
              ?>
                  <tr class="odd">
                    ...
                    <td class=" ">
                      ...
                      <a type="button" class="btn btn-danger btn-xs" href="delete_user.php?id=<?php echo $row['id_user']; ?>" onClick="return confirm('Menghapus data user <?php echo $row['username']; ?> ?');">Delete</a>
                    </td>
                  </tr>
              <?php
                }
