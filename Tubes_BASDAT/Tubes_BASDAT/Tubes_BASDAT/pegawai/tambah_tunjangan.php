    ...
    <div class="row">
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <div class="row">
          <div class="col-md-6">
            <div>
              <form class="form-horizontal" action="proses_tambah_tunjangan.php" method="POST">
                <div class="form-group">
                  <label for="id_tunjangan" class="col-sm-2 control-label">Kode Tunjangan</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="id_tunjangan" id="id_tunjangan" required />
                  </div>
                </div>
                <div class="form-group">
                  <label for="tunjangan_anak" class="col-sm-2 control-label">Tunjangan Anak</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="tunjangan_anak" id="tunjangan_anak" required />
                  </div>
                </div>
                <div class="form-group">
                  <label for="tunjangan_pasutri" class="col-sm-2 control-label">Tunjangan Pasutri</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="tunjangan_pasutri" id="tunjangan_pasutri" required />
                  </div>
                </div>
                <div class="form-group">
                  <label for="uang_makan" class="col-sm-2 control-label">Uang Makan</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="uang_makan" id="uang_makan" required />
                  </div>
                </div>
                <div class="form-group">
                  <label for="uang_lembur" class="col-sm-2 control-label">Uang Lembur</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="uang_lembur" id="uang_lembur" required />
                  </div>
                </div>
                <div class="form-group">
