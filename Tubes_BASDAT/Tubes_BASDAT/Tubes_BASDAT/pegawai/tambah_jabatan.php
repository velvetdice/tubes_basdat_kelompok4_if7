        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div>
                            <form class="form-horizontal" action="proses_tambah_jabatan.php" method="POST">
                                <div class="form-group">
                                    <label for="id_tunjangan" class="col-sm-2 control-label">Kode Jabatan</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <label for="tunjangan_jabatan" class="col-sm-2 control-label">Tunjangan Jabatan</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="tunjangan_jabatan" id="tunjangan_jabatan" required />
                                    </div>
                                </div>
                                <div class="form-group">
